...
exports.emailService = (receivedEmail, userInfo) => {
    ...
    var paramsForSender = {
        ...
        Source: 'jhonathanssegura@gmail.com',  /* required */
        ReplyToAddresses: [
            'jhonathanssegura@gmail.com',
            /* more items */
        ],
    };
    ...
    var paramsForAdmin = {
        Destination: { /* required */
            ...
            ToAddresses: [
                'jhonathanssegura@gmail.com'//Email address/addresses that you want to send your email
                /* more items */
            ]
        },
        Message: { /* required */
